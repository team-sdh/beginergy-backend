...
func routes(_ app: Application) throws {
    ...
    app.get("predict", ":day") { req async -> String in
        ...
        do {
            ...
            for index in 0...23 {
                let prediction1 = try model.prediction(Day: day, Start: Double(index), End: Double(index) + 0.5)
                let predictionRead1 = [String(index): prediction1.Value]
                halfHourPredictions.append(predictionRead1)
